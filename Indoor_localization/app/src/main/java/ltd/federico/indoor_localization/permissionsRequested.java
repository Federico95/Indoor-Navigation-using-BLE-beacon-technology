...
public class permissionsRequested extends AppCompatActivity {
    ...
    /* Explain this */
    private static permissionsRequested thisActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thisActivity = this;
        setContentView(R.layout.activity_permissions_requested);
    ...
    public void onCLickRequestLocationButton (View v)
    {
        Intent requestLocationIntent = new Intent(this, setFieldDimensions.class);
